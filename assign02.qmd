...
- Web search interval is monthly (61 entries) records every 01 of the month, script interval is weekly (262 entries) records start September 12.

- Because the observations occur at different intervals and dates, the individual `hits` values cannot be directly compared.
...
The gap shows that a search term does not always capture the exact concept we want to measure. For example, searching “Harris” may capture searches about Kamala Harris, but it can also include searches for Harris County, Harris Teeter, or other people and places. This means that the Google Trends value for “Harris” can include unrelated searches, making it an imperfect measure of interest in Kamala Harris.
